...
class MainProduct(models.Model):
    ...
    product_img = models.ImageField(upload_to=upload_image_path, null=True, blank=True)
...
class SubProduct(models.Model):
    ...
    main_product = models.ForeignKey(
        MainProduct, default=None, on_delete=models.CASCADE
    )
    title = models.CharField(max_length=50)
    short_description = models.TextField(default="")
    description = RichTextField()
...
class SubProductGallery(models.Model):
    ...
    sub_product = models.ForeignKey(
        SubProduct, default=None, related_name="images", on_delete=models.CASCADE
    )
